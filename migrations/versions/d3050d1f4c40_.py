...
Revision ID: d3050d1f4c40
Revises: None
Create Date: 2016-06-01 11:43:14.604697

"""

# revision identifiers, used by Alembic.
revision = 'd3050d1f4c40'
down_revision = None
...
def upgrade():
    ...
    sa.Column('pincode', sa.String(length=512), nullable=True),
    ...
    sa.Column('order_source', sa.String(length=255), nullable=True),
    ...
    sa.Column('updated_on', sa.DateTime(), server_default=sa.text(u'now()'), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('parent_order_id', sa.String(length=255), nullable=False),
    ...
    sa.Column('pg_txn_id', sa.String(length=255), nullable=True),
    sa.Column('bank_txn_id', sa.String(length=255), nullable=True),
